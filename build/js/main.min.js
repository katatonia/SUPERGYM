...
/* harmony import */ var _modules_reviews_slider__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/reviews-slider */ "./js/modules/reviews-slider.js");
/* harmony import */ var _modules_local_storage__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/local-storage */ "./js/modules/local-storage.js");
/* harmony import */ var _modules_show_card__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/show-card */ "./js/modules/show-card.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_video__WEBPACK_IMPORTED_MODULE_2__["onPlayClick"])();
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_3__["onTabBtnClick"])();
  Object(_modules_trainers_slider__WEBPACK_IMPORTED_MODULE_4__["createTrainersSlider"])();
  Object(_modules_reviews_slider__WEBPACK_IMPORTED_MODULE_5__["createReviewsSlider"])();
  Object(_modules_local_storage__WEBPACK_IMPORTED_MODULE_6__["onFormSubmit"])();
  Object(_modules_show_card__WEBPACK_IMPORTED_MODULE_7__["onCardClick"])();
...
/*!**************************************!*\
  !*** ./js/modules/reviews-slider.js ***!
  \**************************************/
/*! exports provided: createReviewsSlider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createReviewsSlider", function() { return createReviewsSlider; });
...
/*!*********************************!*\
  !*** ./js/modules/show-card.js ***!
  \*********************************/
/*! exports provided: onCardClick */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "onCardClick", function() { return onCardClick; });
var cards = document.querySelectorAll('.trainers__item');
var clickOnCard = function clickOnCard(e) {
  cards.forEach(function (info) {
    var cardsInfo = info.querySelector('.trainers__info');
    var cardsTitle = info.querySelector('h3');
    cardsInfo.classList.remove('flex');
    cardsTitle.classList.remove('none');
  });
  var card = e.currentTarget;
  var cardInfo = card.querySelector('.trainers__info');
  var cardPhoto = card.querySelector('.trainers__photo');
  var cardTitle = cardPhoto.querySelector('h3');
  cardInfo.classList.add('flex');
  cardTitle.classList.add('none');
};
var showCardInfo = function showCardInfo() {
  if (cards) {
...
var stopShowCardInfoByClick = function stopShowCardInfoByClick() {
  if (cards) {
    cards.forEach(function (item) {
      var cardsInfo = item.querySelector('.trainers__info');
      var cardsTitle = item.querySelector('h3');
      cardsInfo.classList.remove('flex');
      cardsTitle.classList.remove('none');
...
/*!****************************!*\
  !*** ./js/modules/tabs.js ***!
  \****************************/
/*! exports provided: onTabBtnClick */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "onTabBtnClick", function() { return onTabBtnClick; });
/* harmony import */ var _utils_remove_class__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/remove-class */ "./js/utils/remove-class.js");

var tabBtns = document.querySelectorAll('.tabs__btn');
var tabLists = document.querySelectorAll('.tabs__list');
var onTabBtnClick = function onTabBtnClick() {
  Object(_utils_remove_class__WEBPACK_IMPORTED_MODULE_0__["removeClass"])(tabBtns);
  Object(_utils_remove_class__WEBPACK_IMPORTED_MODULE_0__["removeClass"])(tabLists);
...
/*!***************************************!*\
  !*** ./js/modules/trainers-slider.js ***!
  \***************************************/
/*! exports provided: createTrainersSlider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createTrainersSlider", function() { return createTrainersSlider; });
var trainersSwiper = document.querySelector('.trainers__swiper');
var trainersButtonPrev = document.querySelector('.trainers__button-prev');
var trainersButtonNext = document.querySelector('.trainers__button-next');
var createTrainersSlider = function createTrainersSlider() {
  if (trainersSwiper) {
    // eslint-disable-next-line
...
/*!*****************************!*\
  !*** ./js/modules/video.js ***!
  \*****************************/
/*! exports provided: onPlayClick */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "onPlayClick", function() { return onPlayClick; });
