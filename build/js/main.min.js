...
var reviewsContainer = document.querySelector('.reviews-slider');
var createReviewsSlider = function createReviewsSlider() {
  if (reviewsContainer) {
    var reviewsSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.reviews-slider', {
      loop: true,
      slidesPerView: 1,
      spaceBetween: 57,
      navigation: {
...
var trainersContainer = document.querySelector('.trainers-slider');
var createTrainersSlider = function createTrainersSlider() {
  if (trainersContainer) {
    var trainersSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.trainers-slider', {
      loop: true,
      navigation: {
